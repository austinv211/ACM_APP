package com.example.acm_app_austinvargason.recyclerview;
...
import com.example.acm_app_austinvargason.Event;
import com.example.acm_app_austinvargason.R;
import com.squareup.picasso.Picasso;

import java.util.List;

//RecyclerHackathons is our “adapter”, you can tell by the fact that is extends RecyclerView.Adapter
//Since we extend the following class, we then MUST implement the abstract methods in the superclass.
//Since Adapter is a parameterized class, we must supply it with the needed information.
//Here, we will supply it with the RecyclerHackathons.RecyclerView Holder which are classes we make.
public class RecyclerHackathons extends RecyclerView.Adapter<RecyclerHackathons.RecyclerViewHolder>{
    ...
    public class RecyclerViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener{
        ...
        //This may be a little different for you, depending our what views you decide to use for your item.
        ...
        void bind(final int position) {
            //Here is where we use the Picasso library to load the url image into our
